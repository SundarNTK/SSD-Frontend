...
export const TempleIcon = (p: IconProps) => (
  <Svg {...p}>
    <path d="M12 3v3M9 6h6l1.5 4h-9L9 6Z" />
    <path d="M6.5 10 5 14h14l-1.5-4" />
    <path d="M5 14v7h14v-7M10 21v-4a2 2 0 0 1 4 0v4" />
  </Svg>
);
...
export const StarIcon = ({ className = "h-4 w-4", filled = true }: IconProps & { filled?: boolean }) => (
  <svg viewBox="0 0 24 24" className={className} aria-hidden="true" fill={filled ? "currentColor" : "none"} stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round">
    <path d="m12 3 2.7 5.6 6.1.8-4.5 4.3 1.1 6.1L12 16.8 6.6 19.8l1.1-6.1L3.2 9.4l6.1-.8L12 3Z" />
  </svg>
);

export const FacebookIcon = ({ className = "h-4 w-4" }: IconProps) => (
  <svg viewBox="0 0 24 24" className={className} fill="currentColor" aria-hidden="true">
    <path d="M13.5 21v-7.5H16l.5-3h-3V8.6c0-.9.3-1.5 1.6-1.5h1.5V4.4c-.3 0-1.2-.1-2.2-.1-2.3 0-3.9 1.4-3.9 4v2.2H8v3h2.5V21h3Z" />
  </svg>
);
